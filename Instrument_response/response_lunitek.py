...
Code to test the instrument response removal form Lunitek sensor using my 
...
#%% Reading the data
data = read('/Users/annamaria/PhD/Data/Matera/20201105_building_data/EQ/Lunitek.GE004.EHE.2019.298.04.31.10')
data.plot()
...
poles = paz["Lunitek"]["poles"]  # The poles of the transfer function
zeros = paz["Lunitek"]["zeros"]   # The zeros of the transfer function
scale_fac = paz["Lunitek"]["gain"]         # Gain factor
sensitivity = paz["Lunitek"]["sensitivity"]
...
fig.suptitle("Lunitek", fontsize = 20)
fig.tight_layout()
