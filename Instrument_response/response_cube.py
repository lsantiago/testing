...
Code to test the instrument response removal form CUBE sensor using my 
...
#%% Reading the data
data = read('/Users/annamaria/PhD/Data/Matera/20201105_building_data/EQ/CUBE.c0AAU.p2.2019.298.04.31.10')
data.plot()
...
zeros = paz["CUBE"]["zeros"]   # The zeros of the transfer function
scale_fac = paz["CUBE"]["gain"]         # Gain factor
sensitivity = paz["CUBE"]["sensitivity"]
